INSERT  INTO Performance..WaitStats
        SELECT  wait_type ,
                waiting_tasks_count ,
                max_wait_time_ms AS highest_wait_time_ms ,
                signal_wait_time_ms ,
        ...
        WHERE   wait_time_ms > 0 -- remove zero wait_time
				...
				( 'SLEEP_TASK', 'BROKER_TASK_STOP', 'BROKER_TO_FLUSH', 'SQLTRACE_BUFFER_FLUSH',
				  ...
				  'SQLTRACE_INCREMENTAL_FLUSH_SLEEP', 'RESOURCE_QUEUE', 'SLEEP_DBSTARTUP',
				  'BROKER_MASTERSTART', 'SLEEP_TEMPDBSTARTUP' )
